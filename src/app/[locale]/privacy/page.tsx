    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-14">
        ...
        <div className="space-y-10 text-gray-700">
          ...
          <Section title="第3条（要配慮個人情報の取扱い）">
            <p>
              本サービスの性質上、利用者が入力する情報には、健康状態、生活状況、家庭環境等の要配慮個人情報が含まれる場合があります。利用者は、これらの情報を自らの意思により提供するものとします。
            </p>
          </Section>

          <Section title="第4条（個人情報の保護（SOSユーザー向け））">
          ...
          <Section title="第6条（委託先・外部サービスの利用）">
          ...
          <Section title="第10条（安全管理措置）">
            <p>
              当社は、個人情報の漏えい、紛失、改ざん、不正アクセス等を防止するため、合理的かつ適切な安全管理措置を講じ（アクセス制御、通信の暗号化、ログ管理等の技術的安全管理措置を含みます）、個人情報を適切に管理します。ただし、インターネット経由のデータ送信には固有のリスクが伴い、完全な安全性を保証するものではありません。万が一情報漏洩発覚時には、個人情報保護委員会への報告と対象者への通知を行います。
            </p>
          </Section>

          <Section title="第11条（統計情報の利用）">
            <p>
              当社は、取得した情報を、個人を特定できない形式に加工した統計情報として作成し、本サービスの改善、研究または分析の目的で利用する場合があります。
            </p>
          </Section>

          <Section title="第12条（個人情報の保管期間）">
            <p>
              当社は、個人情報を利用目的の達成に必要な期間に限り保管し、その後は法令に従い適切な方法で削除または匿名化します。なお、退会と同時にSOSユーザーの個人情報を削除します。
            </p>
          </Section>

          <Section title="第13条（個人情報の開示・訂正・削除等）">
            <p>
              利用者は、当社が保有する自己の個人情報について、法令の定めに従い、開示、訂正、削除または利用停止を求めることができます。当社は、これらの請求があった場合、法令に基づき適切に対応します。
            </p>
          </Section>

          <Section title="第14条（未成年者の利用）">
            <p>
